...
function buildToolInstructions(agent: Agent): string {
  ...
  return [
    ...
    "ขั้นตอน: ① ใช้ file_finder ค้นหาไฟล์ก่อน → ② ถ้ามีหลายปี ใช้ multi_csv_reader(file_ids='id1,id2,...', filter_years='2565-2569') อ่านทีเดียว",
    "         ถ้าต้องการปีเดียว ใช้ csv_reader(file_id=...) แทน",
    "รูปแบบ:",
    usageLines,
